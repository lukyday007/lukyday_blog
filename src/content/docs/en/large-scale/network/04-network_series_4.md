...
<div style="display:flex;flex-direction:column;align-items:center;gap:0;width:100%;">
  ...
  <div style="border-radius:8px;padding:10px 20px;font-size:13px;text-align:center;background:#EEEDFE;border:0.5px solid #7F77DD;color:#3C3489;font-weight:500;width:220px;">DNS Server<div style="font-size:11px;color:#534AB7;margin-top:3px;font-weight:400;">Returns a different IP each time</div></div>
  ...
  <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:8px;width:100%;margin-top:4px;">
    <div style="border-radius:8px;padding:10px 16px;font-size:12px;font-weight:500;text-align:center;background:#E6F1FB;border:0.5px solid #378ADD;color:#185FA5;">Server A<br><span style="font-size:10px;font-weight:400;">192.168.0.1</span></div>
    <div style="border-radius:8px;padding:10px 16px;font-size:12px;font-weight:500;text-align:center;background:#EAF3DE;border:0.5px solid #639922;color:#3B6D11;">Server B<br><span style="font-size:10px;font-weight:400;">192.168.0.2</span></div>
    <div style="border-radius:8px;padding:10px 16px;font-size:12px;font-weight:500;text-align:center;background:#FAEEDA;border:0.5px solid #BA7517;color:#854F0B;">Server C<br><span style="font-size:10px;font-weight:400;">192.168.0.3</span></div>
  </div>
</div>
...
<div style="border:0.5px solid var(--sl-color-gray-5);border-radius:12px;padding:1.25rem;margin:1.5rem 0;">
  ...
  <div style="display:flex;flex-direction:column;gap:0;">
    <div style="border-radius:8px;padding:10px 14px;font-size:13px;text-align:center;background:var(--sl-color-bg-nav);border:0.5px solid var(--sl-color-gray-5);font-weight:500;">Client Request</div>
    <div style="font-size:18px;color:var(--sl-color-gray-3);line-height:1.2;text-align:center;">↓</div>
    <div style="border-radius:8px;padding:10px 14px;background:#E6F1FB;border:0.5px solid #378ADD;">
    ...
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:8px;">
      <div style="border-radius:8px;padding:8px;font-size:11px;font-weight:500;text-align:center;background:var(--sl-color-bg-nav);border:0.5px solid var(--sl-color-gray-5);color:var(--sl-color-gray-2);">Server A</div>
      <div style="border-radius:8px;padding:8px;font-size:11px;font-weight:500;text-align:center;background:var(--sl-color-bg-nav);border:0.5px solid var(--sl-color-gray-5);color:var(--sl-color-gray-2);">Server B</div>
    </div>
...
<div style="border:0.5px solid var(--sl-color-gray-5);border-radius:12px;padding:1.25rem;margin:1.5rem 0;">
  ...
  <div style="display:flex;flex-direction:column;gap:0;">
    <div style="border-radius:8px;padding:10px 14px;font-size:13px;text-align:center;background:var(--sl-color-bg-nav);border:0.5px solid var(--sl-color-gray-5);font-weight:500;">Client Request</div>
    <div style="font-size:18px;color:var(--sl-color-gray-3);line-height:1.2;text-align:center;">↓</div>
    <div style="border-radius:8px;padding:10px 14px;background:#E1F5EE;border:0.5px solid #1D9E75;">
    ...
    <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:8px;">
      <div style="border-radius:8px;padding:8px;font-size:11px;font-weight:500;text-align:center;background:#E6F1FB;border:0.5px solid #378ADD;color:#185FA5;">Payment Server</div>
      <div style="border-radius:8px;padding:8px;font-size:11px;font-weight:500;text-align:center;background:#EAF3DE;border:0.5px solid #639922;color:#3B6D11;">Product Server</div>
      <div style="border-radius:8px;padding:8px;font-size:11px;font-weight:500;text-align:center;background:#FAEEDA;border:0.5px solid #BA7517;color:#854F0B;">User Server</div>
    </div>
