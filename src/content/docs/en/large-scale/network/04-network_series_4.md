...
<div style="display:flex;flex-direction:column;align-items:center;gap:0;">
  ...
  <table style="width:100%;border-collapse:separate;border-spacing:8px;margin-top:4px;">
  <tr>
    <td style="border-radius:8px;padding:10px 16px;font-size:12px;font-weight:500;text-align:center;background:#E6F1FB;border:0.5px solid #378ADD;color:#185FA5;">Server A<br><span style="font-size:10px;font-weight:400;">192.168.0.1</span></td>
    <td style="border-radius:8px;padding:10px 16px;font-size:12px;font-weight:500;text-align:center;background:#EAF3DE;border:0.5px solid #639922;color:#3B6D11;">Server B<br><span style="font-size:10px;font-weight:400;">192.168.0.2</span></td>
    <td style="border-radius:8px;padding:10px 16px;font-size:12px;font-weight:500;text-align:center;background:#FAEEDA;border:0.5px solid #BA7517;color:#854F0B;">Server C<br><span style="font-size:10px;font-weight:400;">192.168.0.3</span></td>
  </tr>
  </table>
</div>
...
<div style="border:0.5px solid var(--sl-color-gray-5);border-radius:12px;padding:1.25rem;margin:1.5rem 0;">
  ...
  <div style="display:flex;flex-direction:column;align-items:center;gap:0;">
    ...
    <tr>
      ...
      <td style="border-radius:8px;padding:8px;font-size:11px;font-weight:500;text-align:center;background:#FAEEDA;border:0.5px solid #BA7517;color:#854F0B;">User Server</td>
    </tr>
    </table>
